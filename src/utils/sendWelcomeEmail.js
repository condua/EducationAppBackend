          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; background-color:#ffffff;">
            ...
            <tr>
              <td style="padding: 30px;">
                <h2 style="margin-top:0; font-size:20px; color:#00264d;">Cảm ơn bạn đã đăng ký tài khoản thành công! <span style="color:#f7c800;">🌟</span></h2>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td style="padding-left:15px; font-size:13px; color:#333;">
                      <div style="font-weight:bold;">Phan Hoàng Phúc</div>
